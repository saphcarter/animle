...
#### Other
There is a White_Box_Database_Testing.txt file in /Developer_Guide dir. This has some visually varifiable tests as we are testing in a 'white box' environment.
